---
name: hydra-task-state
description: Run the Hydra task-state lifecycle (start, checkpoint, complete, list) through the canonical helper.
argument-hint: [start|checkpoint|complete] [name]
disable-model-invocation: true
allowed-tools: Bash(python3 .hydra-framework/scripts/hydra.py task *) Bash(python3 .hydra-framework/scripts/hydra.py validate)
---
